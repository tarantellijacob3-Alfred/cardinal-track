...
INSERT INTO events (name, short_name, category, max_entries, is_relay) VALUES
  ('Pole Vault', 'PV', 'Field', 4, false),
  ('High Jump', 'HJ', 'Field', 4, false),
  ('Long Jump', 'LJ', 'Field', 4, false),
  ('Triple Jump', 'TJ', 'Field', 4, false),
  ('Shot Put', 'Shot', 'Field', 4, false),
  ('Javelin', 'Jav', 'Field', 4, false),
  ('Discus', 'Disc', 'Field', 4, false),
  ('100m', '100m', 'Sprint', 4, false),
  ('200m', '200m', 'Sprint', 4, false),
  ('400m', '400m', 'Sprint', 4, false),
  ('800m', '800m', 'Distance', 4, false),
  ('1600m', '1600m', 'Distance', 4, false),
  ('3200m', '3200m', 'Distance', 4, false),
  ('100m Hurdles', '100mH', 'Hurdles', 4, false),
  ('110m Hurdles', '110mH', 'Hurdles', 4, false),
  ('400m Hurdles', '400mH', 'Hurdles', 4, false),
  ('4x100 Relay A', '4x100A', 'Relay', 4, true),
  ('4x100 Relay Alt', '4x100Alt', 'Relay', 4, true),
  ('4x400 Relay A', '4x400A', 'Relay', 4, true),
  ('4x400 Relay Alt', '4x400Alt', 'Relay', 4, true),
  ('4x800 Relay A', '4x800A', 'Relay', 4, true),
  ('4x800 Relay Alt', '4x800Alt', 'Relay', 4, true),
