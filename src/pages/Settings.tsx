...
export default function Settings() {
  ...
  const pendingCoachRequests = profiles.filter(p => p.approved === false)
  const coaches = profiles.filter(p => p.approved === true)
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Parents/Students removed — coach-only access */}
    </div>
  )
}
