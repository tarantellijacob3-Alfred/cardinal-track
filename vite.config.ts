  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        runtimeCaching: [
          {
            // Supabase API calls — ALWAYS go to network first
            // This prevents stale data issues when multiple tabs are open
            ...
            options: {
              ...
              expiration: {
                maxEntries: 50,
                maxAgeSeconds: 60 * 5, // 5 min max for fallback
              },
          ...
          {
            // Static assets (images, etc) from Supabase storage
